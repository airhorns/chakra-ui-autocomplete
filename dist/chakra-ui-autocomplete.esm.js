...
var CUIAutoComplete = function CUIAutoComplete(props) {
  ...
  return createElement(Stack, null, label && createElement(FormLabel, Object.assign({}, _extends({}, getLabelProps({}), labelStyleProps)), label), selectedItems && createElement(Stack, {
    spacing: 2,
    isInline: true,
    flexWrap: 'wrap'
